...
VIDEOS = [
    ...
    # ==== סבב שלישי - סרטונים חדשים (24/9/2026) ====
    # זוהו בדרייב לפי בקשת המשתמש: 10 תת-תיקיות חדשות מאותו יום, בתבנית "<כותרת> 24.9".
    # 5 מתוכן משתמשות בקבצי וידאו שהיו בעבר "יתומים" בשורש התיקייה (בלי תת-תיקייה/טקסט) -
    # עכשיו מאורגנים כמו שצריך עם קובץ טקסט לצידם.
    {"match": "אזור הנוחות גדל", "ad_set_name": "ככה אזור הנוחות גדל",
     "message": "רוב האנשים מחכים להרגיש מוכנים לפני שהם יוצאים מאזור הנוחות, אבל זה עובד הפוך - גישה תמיד באה לפני כישרון. עוד תוכן כזה - עקבו באינסטגרם",
     "title": "גישה לפני כישרון",
     "description": "איך אזור הנוחות שלך גדל בפועל",
     "category": "personal_dev_psych"},
    {"match": "בסופר פוזיציה", "ad_set_name": "אנחנו תמיד בסופר פוזיציה",
     "message": "ברגע הזה קיימות אינספור גרסאות אפשריות לחיים שלך, אבל אתה תחיה רק אחת מהן - את זו שההחלטות שלך בונות. עוד תוכן כזה - עקבו באינסטגרם",
     "title": "איזו מציאות אתה בוחר?",
     "description": "ההחלטות שלך הן שבונות את החיים שלך",
     "category": "personal_dev_psych"},
    {"match": "זמן דגירה", "ad_set_name": "זמן דגירה",
     "message": "הטעות של רוב האנשים היא שהם שופטים משהו לפני שהוא בכלל הספיק להבשיל - לכל דבר בחיים יש זמן דגירה. עוד תוכן כזה - עקבו באינסטגרם",
     "title": "לכל דבר יש זמן דגירה",
     "description": "למה שיפוט מוקדם הורג תהליכים",
     "category": "personal_dev_psych"},
    {"match": "שתי דרכים לשנות את הסיפור", "ad_set_name": "שתי דרכים לשנות את הסיפור",
     "message": "יש שתי דרכים לשנות את הסיפור שאתה מספר לעצמך - אירוע רגשי עמוק, או חזרתיות שבשליטה שלך. עוד תוכן כזה - עקבו באינסטגרם",
     "title": "שתי דרכים לשנות את הסיפור שלך",
     "description": "אירוע מטלטל, או חזרתיות בשליטה שלך",
     "category": "personal_dev_psych"},
    {"match": "היקום תמיד בשאיפה להתרחב", "ad_set_name": "היקום תמיד בשאיפה להתרחב",
     "message": "היקום כל הזמן בתנועה של התרחבות, ואנחנו לא נפרדים מזה - אנחנו חלק ממנו. עוד תוכן כזה - עקבו באינסטגרם",
     "title": "אנחנו חלק מההתרחבות של היקום",
     "description": "התפתחות היא הטבע שלנו, לא מאבק",
     "category": "personal_dev_psych"},
    {"match": "להאמין מעבר לעצמך", "ad_set_name": "להאמין מעבר לעצמך",
     "message": "כשאתה מאמין רק בעצמך, כישלון יכול לערער אותך - אבל כשאתה מאמין שיש משהו גדול ממך, הכישלון הופך לשיעור. עוד תוכן כזה - עקבו באינסטגרם",
     "title": "אמונה גדולה ממך",
     "description": "למה זה נותן לך למה להישען עליו גם בכישלון",
     "category": "personal_dev_psych"},
    {"match": "אחריות היא חופש", "ad_set_name": "אחריות היא חופש",
     "message": "רוב האנשים חושבים שאחריות מכבידה עליהם, אבל האמת הפוכה - אחריות היא חופש. עוד תוכן כזה - עקבו באינסטגרם",
     "title": "אחריות היא חופש",
     "description": "איך לוקחים בחזרה את השליטה בחיים",
     "category": "personal_dev_psych"},
    {"match": "מי באמת מגביל אותך", "ad_set_name": "מי באמת מגביל אותך",
     "message": "אנחנו תמיד פועלים ביחס לגובה התודעה שלנו - ומה שאנחנו מאמינים שאפשרי, משפיע ישירות על מה שאנחנו עושים. עוד תוכן כזה - עקבו באינסטגרם",
     "title": "מי באמת מגביל אותך?",
     "description": "הגבול הוא האמונה, לא המציאות",
     "category": "personal_dev_psych"},
    {"match": "תעלה נקודת מבט", "ad_set_name": "תעלה נקודת מבט",
     "message": "ככל שאתה יודע לעלות בפרספקטיבה שלך, ככה אתה פחות נשאב לדרמה. עוד תוכן כזה - עקבו באינסטגרם",
     "title": "פרספקטיבה גבוהה, פחות דרמה",
     "description": "איך לצאת מהתגובתיות ולהיכנס לרוח",
     "category": "personal_dev_psych"},
    {"match": "כסף הוא סמל של ערך", "ad_set_name": "כסף הוא סמל של ערך",
     "message": "כסף הוא בסך הכול סמל של ערך - ככל שאתה יודע לייצר יותר ערך בעולם, כך גדל גם פוטנציאל ההכנסה שלך. עוד תוכן כזה - עקבו באינסטגרם",
     "title": "כסף הוא סמל של ערך",
     "description": "איך תפיסת הערך העצמי משפיעה על ההכנסה",
     "category": "personal_dev_psych"},
]
